      ...
      <div
        ...
        <ul className="flex flex-col lg:flex-row lg:space-x-4 space-y-2 lg:space-y-0">
          {user ? (
            <li className="lg:hidden">
              ...
              {isDropdownOpen && (
                <div className="text-white dropdown bg-secondary rounded lg:shadow-[20px_25px_90px_10px_rgba(1,1,1,0.8)]">
                  ...
                  <Link to="/help" className="block px-4 py-2">
                    Ajuda
                  </Link>
                </div>
              )}
            ...
            <Link to="/login" className="text-white hover:underline lg:hidden">
              Login
            </Link>
          )}
          ...
          {user && (
            <>
              ...
              <li>
                <Link to="/exchange" className="text-white hover:underline">
                  Cotação
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/traders" className="text-white hover:underline">
                  Traders
                </Link>
              </li>
              <li>
            ...
            <li className="max-lg:hidden" ref={dropdownRef} onClick={toggleDropdown}>
              ...
              {isDropdownOpen && (
                <div className="text-white dropdown bg-secondary rounded lg:shadow-[20px_25px_90px_10px_rgba(1,1,1,0.8)] absolute right-1 mt-2 py-2">
                  ...
                  <span onClick={handleLogout} className="block px-4 py-2 hover:bg-gray-200">
                    Sair
                  </span>
                </div>
              )}
